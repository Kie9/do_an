                ...
                <form class="signup-form" autocomplete="off" name="admin">
                    ...
                    <?php
						if(in_array('email', $errorsArray)){
							echo '<div style="margin-top:10px; color:red;">Email đã tồn tại hoặc lỗi đã xảy ra</div>';
						}
					?><br>
                    <label class="signup-label">
                        Mật khẩu
                    ...
                    <input type="text" class="signup-input" name="cmnn" id="cmnn" minlength="12" maxlength="12">
                    <label class="signup-label">
                        Cấp Độ
                    </label>

...
foreach ($_SESSION['gio_hang'] as $ma_san_pham => $so_luong) {
	$sql = "insert into hoa_don(ma_san_pham,ma_khach_hang,thoi_gian_dat_hang,ten_nguoi_nhan,sdt_nguoi_nhan,dia_chi_nguoi_nhan,tinh_trang)
	values('$ma_san_pham','$ma_khach_hang','$thoi_gian_dat_hang','$ten_nguoi_nhan','$sdt_nguoi_nhan','$dia_chi_nguoi_nhan','$tinh_trang')";
